...
public class TESR_WeaponForge extends TileEntitySpecialRenderer
{
	private static final float pixelSize = 0.0625f;
	public Model_WeaponForge model = new Model_WeaponForge();
	
	TileEntity_WeaponForge weaponForgeTileEntity;
	...
	{
		renderWeaponForgeAt((TileEntity_WeaponForge)tileEntity, x, y, z, partialTickTime);
	}
	
	public void renderWeaponForgeAt(TileEntity_WeaponForge tileEntity, double x, double y, double z, float partialTickTime)
	{
		int i = 0;
