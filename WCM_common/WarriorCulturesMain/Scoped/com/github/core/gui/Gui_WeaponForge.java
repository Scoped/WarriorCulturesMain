...
public class Gui_WeaponForge extends GuiContainer
{
	...
	public Gui_WeaponForge(InventoryPlayer inventoryPlayer, TileEntity_WeaponForge entity, World world, int x, int y, int z)
	{
		super(new Container_WeaponForge(inventoryPlayer, entity, world, x, y, z));
