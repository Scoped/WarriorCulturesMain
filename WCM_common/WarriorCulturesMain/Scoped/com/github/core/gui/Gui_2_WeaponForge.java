...
public class Gui_2_WeaponForge extends GuiContainer
{
	...
	public TileEntity_2_WeaponForge weaponForge;
	
	public Gui_2_WeaponForge(InventoryPlayer inventoryPlayer, TileEntity_2_WeaponForge entity, World world, int x, int y, int z)
	{
		super(new Container_2_WeaponForge(inventoryPlayer, entity, world, x, y, z));
