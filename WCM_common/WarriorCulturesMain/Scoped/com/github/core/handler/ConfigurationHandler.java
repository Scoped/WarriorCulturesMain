...
public class ConfigurationHandler
{
	...
	public static void init(File file)
	{
		...
		try
		{
			...
			BlockIDs.BLOCK_LARGECRAFTINGTABLE_ID = config.getBlock(Strings.BLOCK_LARGECRAFTINGTABLE_NAME, BlockIDs.BLOCK_LARGECRAFTINGTABLE_ID_DEFAULT).getInt(BlockIDs.BLOCK_LARGECRAFTINGTABLE_ID_DEFAULT);
			BlockIDs.BLOCK_WEAPONFORGE_2_ACTIVE_ID = config.getBlock(Strings.BLOCK_WEAPONFORGE_2_ACTIVE_NAME, BlockIDs.BLOCK_WEAPONFORGE_2_ACTIVE_ID_DEFAULT).getInt(BlockIDs.BLOCK_WEAPONFORGE_2_ACTIVE_ID_DEFAULT);
			BlockIDs.BLOCK_WEAPONFORGE_2_IDLE_ID = config.getBlock(Strings.BLOCK_WEAPONFORGE_2_IDLE_NAME, BlockIDs.BLOCK_WEAPONFORGE_2_IDLE_ID_DEFAULT).getInt(BlockIDs.BLOCK_WEAPONFORGE_2_IDLE_ID_DEFAULT);
			 ...
			 */
			ItemIDs.ITEM_MODEL_SWORD_WEAPONFORGE_ID = config.getItem(Strings.ITEM_MODEL_WEAPONFORGE_NAME, ItemIDs.ITEM_MODEL_SWORD_WEAPONFORGE_ID_DEFAULT).getInt(ItemIDs.ITEM_MODEL_SWORD_WEAPONFORGE_ID_DEFAULT);
			...
			ItemIDs.ITEM_TOOLS_WCMTOOLHEADS_ID = config.getItem(Strings.ITEM_TOOLS_WCMTOOLS_NAME, ItemIDs.ITEM_TOOLS_WCMTOOLS_ID_DEFAULT).getInt(ItemIDs.ITEM_TOOLS_WCMTOOLS_ID_DEFAULT);
