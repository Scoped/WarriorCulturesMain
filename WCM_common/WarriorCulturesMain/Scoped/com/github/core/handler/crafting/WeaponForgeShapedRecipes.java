...
public class WeaponForgeShapedRecipes implements IRecipe
{
	...
	public boolean field_92101_f = false;
	
	public WeaponForgeShapedRecipes(int i, int j, ItemStack[] arrayOfItemStack, ItemStack itemStack)
	{
	...
	public WeaponForgeShapedRecipes func_92100_c()
	{
