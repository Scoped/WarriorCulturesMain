...
public class Item_Tools_ForgeTools extends Super_Item
{
	/** List of types. */
    public static final String[] types = new String[] {"Hammer", "Plaiers"};
    public static final String[] field_94595_b = new String[] {"Hammer", "Plaiers"};
    @SideOnly(Side.CLIENT)
    private Icon[] field_94594_d;
    
	public Item_Tools_ForgeTools(int id)
	{
		super(id);
		this.setMaxDamage(0);
		this.setHasSubtypes(true);
		this.setUnlocalizedName(Strings.ITEM_TOOLS_FORGETOOLS_NAME);
	}
    ...
    public void registerIcons(IconRegister icon)
    {
        ...
        {
            this.field_94594_d[i] = icon.registerIcon(String.format("%s:%s", Reference.MOD_ID.toLowerCase(), getUnwrappedUnlocalizedName(this.getIconString() + field_94595_b[i])));
        }
    }
