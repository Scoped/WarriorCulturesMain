...
public class Block_WeaponForge extends BlockContainer
{
	...
	{
		return ModBlocks.WeaponForge_Idle.blockID;
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
	{
		if (!world.isRemote)
		{
			player.openGui(WarriorCultures_Main.instance, 0, world, x, y, z);
		}
	...
	public static void updateWeaponForgeBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord)
	{
		...
		if (active)
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, ModBlocks.WeaponForge_Active.blockID);
		}
		else
		{
			worldObj.setBlock(xCoord, yCoord, zCoord, ModBlocks.WeaponForge_Idle.blockID);
		}
